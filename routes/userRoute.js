...
router.get('/view-order/:id', authenticateUser, getListedCategories, getSingleOrderDetails, getCartItemsCount, getWishItemsCount, getUserOrderDetailsPage)
router.get('/order-invoice/:id', authenticateUser, getListedCategories, getSingleOrderDetails, getCartItemsCount, getWishItemsCount, getUserOrderInvoicePage)
