...
const {getOrderSummaryDetails, placeOrder, verifyPayment} = require('../server/controller/orderController');
const {
    getCartItemsCount,
    getAllCartItems,
    changeCartItemQty,
    ...
    addItemToWishlist,
    getWishItemsCount
} = require('../server/controller/cartController');
const {
    homePage,
    getUserCartPage,
    getUserCheckoutPage,
...
const {
    getFeaturedProducts,
    getSearchProducts,
    getProductsOfSingleCategory,
    getNewProductsOfCategory,
...
router.get('/checkout', authenticateUser, getListedCategories, getAllCartItems, getCartItemsCount, getWishItemsCount, getAllAddresses, getUserCheckoutPage);
