...
const {adminLogin, registerAdmin} = require('../server/controller/adminController');
...
const {
    ...
    updateCategory,
    deleteCategory
} = require('../server/controller/categoryController');
const {
    getProductCount,
    getAllProducts,
    getEditProductItemDetails,
    addNewProduct,
    updateProductItem,
    deleteProductItem
} = require('../server/controller/productController');
const {uploadProductImage, uploadBannerImage, resizeImages} = require('../server/middleware/upload-image');
const {
    getOrderCount,
    getTotalRevenue,
    getMonthlyTotalRevenue,
    getOrderCountPercent,
    getCategoryPerformance,
    getSingleOrderDetails,
    getAllUsersOrders,
    updateOrderStatus,
    getOrderSales,
    getMonthlyOrdersForChart
} = require('../server/controller/orderController');
const {
    adminDashboardPage,
    adminLoginPage,
    adminLogout,
    ...
    getAdminViewOrderPage,
    getAdminOrdersPage,
    getAdminCouponPage,
    getAdminBannerPage,
    getAdminSalesPage
} = require('../server/services/render');
const {authenticateDevMode} = require("../server/middleware/authenticate-dev-mode");

//------- REGISTER API ROUTE (only in dev mode) --------//
router.post('/register', authenticateDevMode, registerAdmin);
